...
//				testin[i] = test11[0]*arm_sin_f32(2*3.1415926f*test11[1]*i/4096);
//			integ_init(4096,4096,test11[2],test11[3],4,1000);
//			frq_domain_integral(testin,testout);
//			arm_rms_f32(testin, 4096, &Parameter.vs[0]);
//			arm_rms_f32(testout, 4096, &Parameter.vs[1]);
//			for(uint32_t i=0;i<4096;i++)
//			{
//				mems_emu_data[SAMPLEblock][0][i]=testin[i];
//				mems_emu_data[SAMPLEblock][1][i]=testout[i];
//			}
//		}
		for(uint32_t j=0;j<AD7682_ADCHS;j++)
		{
